...
def display_houses(subdivision):
    ...
    for group, group_houses in groups.items():
        ...
        for house in group_houses:
            status = 'Active' if house.get('active', False) else 'Closed' if house.get('closed', False) else 'Unknown'
